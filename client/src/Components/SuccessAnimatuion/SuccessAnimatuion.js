...
import { arrayOfClothes } from "../../features/productSlice";
import { resetIsClicked } from "../../features/isClicked";
import { resetQuantity } from "../../features/cartSlice";
...
const SuccessAnimation = () =>{
    ...
    const animationRef = useRef(null);
      let array = []
        ...
        useEffect(()=>{
            ...
            sessionStorage.setItem("isClicked",JSON.stringify([false,false,true,false]))
            sessionStorage.setItem("quantity",JSON.stringify(array))
            dispatch(cartAssign([]))
    ...
    return(
        <div ref={containerRef} className="successAnimationDiv"/>)
}

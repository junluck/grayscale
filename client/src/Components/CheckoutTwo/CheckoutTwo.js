...
function CheckoutTwo(){
    ...
    const [isEmptyOrNot, setIsEmptyOrNot] = useState(true)
    ...
    useEffect(()=>{
                 ...
                 if(cartSlice.length <= 0){
                    ...
                    setIsEmptyOrNot(false)
                 }
                 else{
                    dispatch(isClickedBoolFourTrue())
                 }
                 if(cartSlice.length < 4 && cartSlice.length > 0){
                    setIsClickedFive(false)
                 }
                 else{
                    setIsClickedFive(true)
                 }
    ...
    return(
            <div className={isClickedFive?"mainCheckoutTwo":"mainCheckoutTwoActive"}>
                ...
                {isEmptyOrNot && <div className="groupCheckoutsTwo">

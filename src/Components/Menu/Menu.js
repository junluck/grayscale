...
function Menu({isClickedFour}){
    ...
    function arraySetter(index,arrayNew){
        let array = [...arrayNew];
        array[index] = !array[index];
        setIsClickedFive(array)   
        console.log(array)
    }
    return(
